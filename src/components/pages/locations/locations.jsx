  ...
  render() {
    return (
      <div className="about-page-wrap locations">
        <Helmet>
          <title>City Garden | Lokacija</title>
        </Helmet>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12 col-sm-12 content-left pl-md-3">
                ...
                <p className="col-lg-10 col-md-12 col-sm-12 text-black">
                  Stambeno-poslovni objekat City Garden se nalazi u ulici
            ...
            <div className="row align-items-center ">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 content-right">
                ...
                <p className="col-lg-11 col-md-12 col-sm-12 text-black">
                  Stambeno poslovna zgrada City Garden se sastoji od poslovnog
                  prostora i 42 stana u ulici Vojvode Pavla Cukića, dok je
                  parking prostor planiran u zadnjem delu dvorišta sa 22 parking
                  mesta.
                  <br /> <br />
