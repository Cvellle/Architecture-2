        ...
        <Slider {...settings}>
          <div className="slider-item position-relative">
            <div
              ...
              style={{
                backgroundImage: "url(/assets/images/main-slider/slide1.jpg)"
              }}
            />
            <div className="container">
              <div className="slider-content">
                <div className="text-center w-100">
                  <h2 className="text-white">City Garden</h2>
          ...
          <div className="slider-item position-relative">
            <div
              className="slider-image"
              style={{
                backgroundImage: "url(/assets/images/main-slider/slide2.jpg)"
              }}
            />
            <div className="container">
              <div className="slider-content">
